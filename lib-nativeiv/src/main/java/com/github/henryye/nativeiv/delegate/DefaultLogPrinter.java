...
import com.github.henryye.nativeiv.BuildConfig;
import com.github.henryye.nativeiv.delegate.log.ILogPrinter;
import com.github.henryye.nativeiv.delegate.log.ILogWriter;
...
public class DefaultLogPrinter implements ILogPrinter {
    ...
    @Override
    public void printErrStackTrace(String tag, Throwable t, String msg, Object... args) {
        t.printStackTrace();
    }
}